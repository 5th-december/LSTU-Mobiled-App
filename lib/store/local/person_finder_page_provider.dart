...
class PersonFinderPageProvider extends StatefulWidget
{
  ...
  static PersonFinderPageProviderState of(BuildContext context) {
    PersonFinderPageInherited inherited = context
      .dependOnInheritedWidgetOfExactType<PersonFinderPageInherited>();
...
class PersonFinderPageInherited extends InheritedWidget
{
  ...
  PersonFinderPageInherited({Key key, @required this.pageState, @required child})
    :super(key: key, child: child);

  @override
  bool updateShouldNotify(PersonFinderPageInherited old) => this.pageState != old.pageState;
}
...
class PersonFinderPageProviderState extends State<PersonFinderPageProvider>
{
  ...
  void didChangeDependencies() {
    ...
    ServiceProvider serviceProvider = AppStateContainer.of(context).serviceProvider;
    this.personListBloc = PersonListBloc(personQueryService: serviceProvider.personQueryService);
    this.dialogCreatorBloc = DialogCreatorBloc(messengerQueryService: serviceProvider.messengerQueryService);
  }
