...
class MessengerPageProvider extends StatefulWidget
{
  ...
  static MessengerPageProviderState of(BuildContext context) {
    MessengerPageInherited inherited = context
      .dependOnInheritedWidgetOfExactType<MessengerPageInherited>();
...
class MessengerPageInherited extends InheritedWidget
{
  ...
  @override
  bool updateShouldNotify(MessengerPageInherited old) => this.pageState != old.pageState;
}
...
class MessengerPageProviderState extends State<MessengerPageProvider> 
{
  ...
  void didChangeDependencies() {
    ...
    if(this.dialogListBloc == null) {
      ...
      DialogListLoadingBloc dialogListLoadingBloc = DialogListLoadingBloc(appServiceProvider.messengerQueryService);
