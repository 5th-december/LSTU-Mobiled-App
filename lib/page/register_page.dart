      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                RegisterFormWidget(AppStateContainer.of(context).serviceProvider.authorizationService),
                ElevatedButton(
                  onPressed: () => {
                    AppStateContainer.of(context).blocProvider.authenticationBloc.eventController.add(LoggedOutEvent())
                  }, 
                  child: Text('Отмена')
                )
              ],
