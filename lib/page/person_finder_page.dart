      ...
      child: Row(
        ...
        children: [
          ...
          icon: Icon(Icons.search_rounded), 
            onPressed: () {
              PersonFinderPageProvider.of(context).personListBloc.eventController.sink.add(
                EndlessScrollingLoadEvent<LoadPersonListByTextQuery>(
                  command: LoadPersonListByTextQuery(
                    count: 50, offset: 0, textQuery: queryController.text)));
                    }
                  )
                ],
              ),
