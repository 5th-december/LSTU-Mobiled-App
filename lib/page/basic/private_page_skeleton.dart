...
class _PrivatePageSkeletonState extends State<PrivatePageSkeleton>
{
  ...
  Widget build(BuildContext context) {
    AuthenticationBloc appAuthenticationBloc = AppStateContainer.of(context).blocProvider.authenticationBloc;
    ...
    return StreamBuilder(
      ...
      builder: (
        ...
        if (state is AuthenticationIdentifiedState) {
          return CenteredFormPageSkeleton(centeredForm: RegisterFormWidget(authorizationService, state.identifier));
        }
        else if (state is AuthenticationUnauthorizedState) {
          return CenteredFormPageSkeleton(centeredForm: UserIdentifyFormWidget(authorizationService));
        }
