...
class _SubjectPageManagerState extends State<SubjectPageManager> 
{
    ...
    return getEducationListPage((Education selectedEducation) {
      Navigator.of(context).push(
        MaterialPageRoute(builder: (BuildContext context) {
          return getSemestersListPage(selectedEducation, (Semester selectedSemester) {
            Navigator.of(context).push(
              MaterialPageRoute(builder: (BuildContext context) {
                return getSubjectsListPage(selectedEducation, selectedSemester, (Discipline selectedDiscipline) {
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (BuildContext context) {
                      return DisciplinePage(discipline: selectedDiscipline, semester: selectedSemester, education: selectedEducation);
                    })
                  );
                });
              })
  ...
  Widget getSubjectsListPage(Education education, Semester semester, Function onItemTap) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Дисциплины'),
      ),
      body: DisciplineList(education: education, semester: semester, onItemTap: onItemTap)
    );
  }
