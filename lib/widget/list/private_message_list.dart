...
class _PrivateMessageHistoryListState extends State<PrivateMessageHistoryList> {
  ...
  Widget build(BuildContext context) {
    ...
    EndlessScrollingLoadNextChunkEvent<LoadPrivateChatMessagesListCommand> nextChunkQueryEvent;
    ...
    return EndlessScrollingWidget<PrivateMessage, LoadPrivateChatMessagesListCommand>(
      ...
      buildList: (EndlessScrollingState<PrivateMessage> state) {
        ...
        if(state is EndlessScrollingChunkReadyState){
          LoadPrivateChatMessagesListCommand nextChunkCommand = (state as EndlessScrollingChunkReadyState).nextChunkCommand;
          nextChunkQueryEvent = EndlessScrollingLoadNextChunkEvent<LoadPrivateChatMessagesListCommand>(command: nextChunkCommand);
        ...
        return ListView.builder(
          ...
          reverse: true,
          itemCount: (state is EndlessScrollingChunkReadyState || state is EndlessScrollingLoadingState) ? messageList.length + 1 : messageList.length,
