...
class PersonalDetailsLoaderBloc
  ...
  PersonalDetailsLoaderBloc(PersonQueryService queryService)
      : super(
          ...
          commandArgumentTranslator: (loaderFunc, LoadPersonDetails command) =>
...
/*class EducationDetailsLoaderBloc extends PrimitiveLoaderBloc<
    LoadCurrentEducationsCommand, ListedResponse<Education>, List<Education>> {
  EducationDetailsLoaderBloc(EducationQueryService queryService)
      : super(
            loaderFunc: queryService.getEducationsList,
            commandArgumentTranslator:
                (loaderFunc, LoadCurrentEducationsCommand command) =>
                    loaderFunc(command.person.id),
            valueTranslator: (ListedResponse<Education> argument) =>
                argument.payload);
}*/
...
class SemesterListLoadingBloc extends PrimitiveLoaderBloc<
  ...
  SemesterListLoadingBloc(EducationQueryService queryService)
      : super(
            ...
            valueTranslator: (ListedResponse<Semester> argument) =>
                argument.payload);
}
...
class SubjectListLoadingBloc extends PrimitiveLoaderBloc<LoadSubjectListCommand,
  ...
  SubjectListLoadingBloc(EducationQueryService queryService)
      : super(
            ...
            valueTranslator: (ListedResponse<Discipline> argument) =>
                argument.payload);
}
...
class DisciplineTimetableLoadingBloc
  ...
  DisciplineTimetableLoadingBloc(DisciplineQueryService queryService)
      : super(
            ...
            commandArgumentTranslator:
                (loaderFunc, LoadDisciplineTimetable command) => loaderFunc(
                    command.discipline.id,
                    command.education.id,
                    command.semester.id));
}
...
class TeachingMaterialListLoadingBloc extends PrimitiveLoaderBloc<
  ...
  TeachingMaterialListLoadingBloc(DisciplineQueryService queryService)
      : super(
            ...
            commandArgumentTranslator:
                (loaderFunc, LoadTeachingMaterialsList command) => loaderFunc(
                    command.discipline.id,
                    command.education.id,
                    command.semester.id),
            valueTranslator: (ListedResponse<TeachingMaterial> argument) =>
                argument.payload);
}
